        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Harness the power of AI to generate compelling titles, descriptions, tags, and scripts
              for your YouTube videos. Save hours and grow your channel faster.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 md:p-12">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Join thousands of content creators who are already using TubeGenie to scale their
                  YouTube channels and save countless hours.
                </p>
